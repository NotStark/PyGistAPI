...
class GistClient(Requester):
    ...
    def update_gist(
        ...
        gist = self.get_gist(gist_id=gist_id)
        ...
        return self._request("PATCH", data=data, endpoint=f"/{gist_id}")
    ...
    def delete_gist(self, gist_id: str) -> Dict:
        ...
        """
        return self._request("DELETE", endpoint=f"/{gist_id}")
    ...
    def public_gists(
        ...
        return self._request("GET", endpoint="/public")
    ...
    def starred_gists(
        ...
        return self._request("GET", endpoint="/starred")

    def get_gist(self, gist_id: str, paste: bool = False) -> Dict:
        """
        ...
        """
        gist = self._request("GET", endpoint=f"/{gist_id}")
        if not paste:
            return gist
        content = str()
        if "files" in gist:
    ...
    def gist_forks(self, gist_id: int, per_page: int = 30, page: int = 1) -> List[Dict]:
        """
    ...
    def fork_gist(self, gist_id: int) -> Dict:
        """
        Fork a Gist.
    ...
    def is_gist_starred(self, gist_id: int) -> Dict:
        """
    ...
    def star_gist(self, gist_id: int) -> Dict:
        """
        Star a Gist.
    ...
    def unstar_gist(self, gist_id: int) -> Dict:
        """
        Unstar a Gist.
    ...
    def gist_revision(self, gist_id: int, sha: str) -> Dict:
        """
